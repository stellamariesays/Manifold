...
class TestLoadAll:
    def test_load_all_with_agent(self, builder, agent):
        ...
        assert len(specs) == 58  # +5 tool-use +5 collaboration +5 subscription pack
    ...
    def test_load_all_without_agent(self, builder):
        ...
        assert len(specs) == 51  # +5 tool-use +5 collaboration +5 subscription pack
    ...
    def test_stats_after_loading(self, builder, agent):
        load_all_packs(builder, agent)
        stats = builder.stats()
        assert stats["total_capabilities"] == 58
        assert stats["active"] == 58
