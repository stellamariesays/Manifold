...
class TestLoadAll:
    def test_load_all_with_agent(self, builder, agent):
        ...
        assert len(specs) == 53  # +5 tool-use pack +5 collaboration pack
    ...
    def test_load_all_without_agent(self, builder):
        ...
        assert len(specs) == 46  # +5 tool-use pack +5 collaboration pack
    ...
    def test_stats_after_loading(self, builder, agent):
        load_all_packs(builder, agent)
        stats = builder.stats()
        assert stats["total_capabilities"] == 53
        assert stats["active"] == 53
