{application,numinous,
             [{applications,[kernel,stdlib,elixir,logger,jason]},
              {description,[84,104,101,32,103,114,111,117,110,100,32,116,104,
                            ...
                            102,116,46]},
              {modules,['Elixir.Mix.Tasks.Numinous.Name',
                        'Elixir.Mix.Tasks.Numinous.Open','Elixir.Numinous',
                        'Elixir.Numinous.Application','Elixir.Numinous.Field',
                        'Elixir.Numinous.Void']},
              {registered,[]},
              {vsn,"0.1.0"},
